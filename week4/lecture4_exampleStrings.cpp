...
int main()
{
	...
	cout << "myChar1 " << myCharArray1[0] << myCharArray1[1] << myCharArray1[2] << myCharArray1[3] << endl;
	cout << "myChar2 " << myCharArray2[0] << myCharArray2[1] << myCharArray2[2] << myCharArray2[3] << endl;
	cout << "myChar3 " << myCharArray3[0] << myCharArray3[1] << myCharArray3[2] << myCharArray3[3] << endl;
	...
	myString2 = myString2 + " and Nat Gas";
	...
	//--------------------------------------
	char question1[] = "What is your major?";
	string question2 = "When do you graduate?";
	...
	cout << "Hi, my major is " << answer1; 
	cout << " I graduate in " << answer2;
	cout << endl;
